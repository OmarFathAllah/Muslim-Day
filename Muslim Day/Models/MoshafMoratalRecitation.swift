...
// MARK: - MoshafMoratalRecitation
struct MoshafMoratalRecitation: Decodable {
    let id, addDate: Int
...
// MARK: - Recitation
struct Recitation: Decodable {
    let id: Int
    let title: String
    let addDate: Int
    let type: TypeEnum
    let preparedBy: [PreparedWith]
    let apiURL: String
